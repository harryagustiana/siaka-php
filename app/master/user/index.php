...
<?php require($_SERVER['DOCUMENT_ROOT'].'/header.php'); ?>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
					$res = $con->query("SELECT * FROM kmn_user");
					
					if(isset($_POST['delete'])){
						$sql = "DELETE FROM kmn_user WHERE ID_PENGGUNA=?";
						$delete = $con->prepare($sql);
						$delete->bind_param("s", $_POST['iduser']);
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<?php
											$level = $con->query("SELECT * FROM kmn_levelpengguna WHERE ID_LEVELPENGGUNA = '". $row['ID_LEVELPENGGUNA'] ."'");
											while($rowlevel = $level->fetch_array())
											{
										?>
                                        <td><?php echo $rowlevel['ROLE']; ?></td>
										<?php
											};
										?>
										<td><?php echo $row['TGL_TERDAFTAR']; ?></td>
										<td><?php echo $row['TGL_UBAHDATA']; ?></td>
										<td><a href="edit.php?id=<?php echo $row['ID_PENGGUNA']; ?>" type="button" class="btn btn-sm btn-primary" name="edit">Edit</a>&nbsp;<a href="#confirm-delete" data-id="<?php echo $row['ID_PENGGUNA']; ?>" type="button" class="open-DeleteDialog btn btn-sm btn-danger" name="delete" data-toggle="modal">Delete</a></td>
										<!-- Modal HTML -->
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														<form role="form" action="" method="post">
															<input class="form-control" id="iduser" name="iduser" type="hidden" value="">
